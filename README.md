...
| `.fss` that compile and emit an object | 426 | 321 | `tools/apply-gate.sh` |
| `.fsi` that check | 126 | 126 | `tools/apply-gate.sh` |
| oracle cases that agree with 1.0 | 350 | 350 | `tools/oracle-gate.sh` |
...
corpus file is also LINKED AND RUN under a signal sweep -- 434 binaries.
